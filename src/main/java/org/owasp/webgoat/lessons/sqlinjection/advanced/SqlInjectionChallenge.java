  ...
  public AttackResult registerNewUser(
    ...
    if (attackResult == null) {
      ...
      try (Connection connection = dataSource.getConnection()) {
        // Fix: Use PreparedStatement for the checkUserQuery to prevent SQL Injection
        ...
        attackResult = failed(this).output("Something went wrong during registration.").build();
      }
    }
    return attackResult;
  }
