  ...
  protected String getPassword() {
    ...
    try (Connection connection = dataSource.getConnection()) {
      ...
      try {
        ...
        log.error("SQL Exception during password retrieval", sqle); // Changed from printStackTrace
      }
    } catch (Exception e) {
      log.error("General Exception during password retrieval", e); // Changed from printStackTrace
    }
    return (password);
  }
}
