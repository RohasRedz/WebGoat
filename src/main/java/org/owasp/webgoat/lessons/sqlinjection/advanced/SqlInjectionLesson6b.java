  ...
  protected String getPassword() {
    ...
    try (Connection connection = dataSource.getConnection()) {
      ...
      try {
        ...
        log.error("SQL Exception during password retrieval", sqle); // Replaced printStackTrace
        // do nothing
      }
    } catch (Exception e) {
      log.error("General Exception during password retrieval", e); // Replaced printStackTrace
      // do nothing
    }
    return (password);
  }
