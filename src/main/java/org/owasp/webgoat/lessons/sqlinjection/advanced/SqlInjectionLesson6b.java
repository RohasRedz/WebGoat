  ...
  protected String getPassword() {
    ...
    try (Connection connection = dataSource.getConnection()) {
      ...
      try {
        ...
        log.error("SQL Exception in getPassword", sqle); // Fix: Replaced printStackTrace with log.error
        // do nothing
      }
    } catch (Exception e) {
      log.error("Exception in getPassword", e); // Fix: Replaced printStackTrace with log.error
      // do nothing
    }
    return (password);
  }
