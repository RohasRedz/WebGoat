...
import java.sql.SQLException; // Added for SQLException handling
...
public class Assignment5 implements AssignmentEndpoint {
  ...
  public AttackResult login(
    ...
    } catch (SQLException e) { // Catch SQLException for robust error handling
      log.error("Database error during login for user {}", username_login, e);
      return failed(this).feedback("challenge.error").build();
    }
  }
}
