...
import org.springframework.security.crypto.password.PasswordEncoder; // Changed from NoOpPasswordEncoder
...
public class WebSecurityConfig {
  ...
  public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
    auth.userDetailsService(userDetailsService).passwordEncoder(passwordEncoder()); // Ensure passwordEncoder is used
  }
