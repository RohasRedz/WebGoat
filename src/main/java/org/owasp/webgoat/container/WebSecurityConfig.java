...
public class WebSecurityConfig {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    return http.authorizeHttpRequests(
        ...
        .csrf(csrf -> csrf.ignoringRequestMatchers("/login-oauth.mvc")) // Re-enabled CSRF, ignoring specific path if needed
        .headers(headers -> headers.disable()) // Consider enabling security headers in production
        .exceptionHandling(
            handling ->
